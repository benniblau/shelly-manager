#!/usr/bin/env python3
"""
Shelly Device Manager - Network Scanner and Update Checker

This application scans the local network for Shelly devices and checks for available updates
using the official Shelly APIs.
